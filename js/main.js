...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Booking System Logic - Variable Declarations ---
    ...
    if (document.getElementById('calendarContainer')) {
        calendar = new BookingCalendar('calendarContainer', {
            onDateSelect: (dateString) => {
                // Automatikusan kitölti a dátum mezőt
                dateInput.value = dateString;
                // Frissíti az időpont listát
                populateTimeSlots();
                // Görgessen az űrlaphoz
        ...
        setTimeout(() => {
            ...
            if (typeof sendBookingNotifications === 'function') {
                sendBookingNotifications(booking, {
                    ...
                    console.log('Értesítések elküldve:', results);
                }).catch(error => {
